#create a script that displays a fixation cross inside 
#a blue square of length 50 for half a second, 
# then removes the fixation cross and 
# displays only the blue square of length 50 
